...
async function main() {
  ...
  const permissionsData = [
    ...
    { key: 'gateways:read', description: 'Visualizar integrações de gateways' },
    { key: 'gateways:create', description: 'Configurar novos gateways' },
    ...
    { key: 'catalog:manage', description: 'Gerenciar catálogo' },
    { key: 'inventory:read', description: 'Visualizar estoque' },
    { key: 'inventory:manage', description: 'Gerenciar estoque' },
    { key: 'inventory:adjust', description: 'Ajustar estoque' },
    { key: 'inventory:transfer', description: 'Gerenciar transferências de estoque' },
    { key: 'inventory:cycle-count', description: 'Gerenciar inventários cíclicos' },
    { key: 'inventory:approve', description: 'Aprovar ajustes de inventário físico' },
    { key: 'inventory:alerts-manage', description: 'Gerenciar alertas de estoque' },
    { key: 'inventory:aging-read', description: 'Visualizar aging de estoque' },
    { key: 'inventory:kits-manage', description: 'Gerenciar kits de estoque' },
    { key: 'orders:read', description: 'Visualizar pedidos' },
