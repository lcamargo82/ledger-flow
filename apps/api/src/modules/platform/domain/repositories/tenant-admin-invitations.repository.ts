...
export abstract class TenantAdminInvitationsRepository {
  abstract create(data: Omit<TenantAdminInvitation, 'id' | 'createdAt' | 'updatedAt'>): Promise<TenantAdminInvitation>;
  ...
  abstract updateStatus(id: string, status: 'ACCEPTED' | 'REVOKED' | 'EXPIRED', timestampKey: 'acceptedAt' | 'revokedAt'): Promise<TenantAdminInvitation>;
