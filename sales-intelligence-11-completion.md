...
- [ ] Add tenant low-margin policy and enriched sale detail/read contracts → Verify: Prisma validation and focused service tests.
...
- [ ] Add prioritized alerts through the existing notification/outbound pipeline → Verify: loss, missing-cost, low-margin, disable and idempotency tests.
- [ ] Add permission-aware streamed Sales Intelligence CSV jobs → Verify: bounded batches, redacted columns and CSV injection tests.
